package com.example.charts.line
...
import com.example.charts.line.presentation.LineAreaProvider
import com.example.charts.line.presentation.LineDataProvider
...
class LineChart @JvmOverloads constructor(
    ...
    private var chart = Chart(emptyList())
    private var dataFrame = DataFrameLegacy(emptyList())
    ...
    fun updateNodes(chart: Chart) {
        this.chart = chart
        dataProvider.calculate(chart)
        invalidate()
    }

    fun updateNodes(dataFrame: DataFrameLegacy) {
